...
def mock_emg_stream(
    file_path, num_channels, sampling_rate=100, port=12345, ip="127.0.0.1"
):
...
def sifi_streamer(
    stream_port=12345, stream_ip="127.0.0.1", sifi_port=5000, sifi_ip="127.0.0.1"
):
...
def oymotion_streamer(
    ip="127.0.0.1", port=12345, platform="windows", sampling_rate=1000
):
